...
# wsc search
python benchmark.py --suite  bert.grid_search_auto --num-hosts 1 --num-devices-per-host 8 --no-separate-process --only-mapping --use-analytical-perf-model --hardware wsc --force_use_fp16 --rst_folder tmp_wsc_perf_15GB_fp16


# config parallel, anylytical model, wsc manual, 2x4

python benchmark.py --suite  bert.wsc_config_test --num-hosts 2 --num-devices-per-host 4 --no-separate-process --only-mapping --use-analytical-perf-model --hardware wsc --force_use_fp16 --rst_folder tmp_wsc_perf_15GB_fp16

python benchmark.py --suite  bert.wsc_config_test --num-hosts 1 --num-devices-per-host 2 --no-separate-process --only-mapping --use-analytical-perf-model --hardware wsc --force_use_fp16 --rst_folder tmp_wsc_perf_15GB_fp16
...
python benchmark.py --suite  bert.wsc_config_test --num-hosts 1 --num-devices-per-host 2 --no-separate-process --only-mapping --use-analytical-perf-model --hardware wsc  --rst_folder tmp_wsc_perf_15GB_fp16

python benchmark.py --suite  bert.wsc_config_test --num-hosts 2 --num-devices-per-host 4 --no-separate-process --only-mapping --use-analytical-perf-model --hardware wsc  --rst_folder tmp_wsc_perf_15GB_fp16

python benchmark.py --suite bert.wsc_config_test --num-hosts 5 --num-devices-per-host 4 --no-separate-process --only-mapping --hardware wsc --use-analytical-perf-model --use-greedy-collective-cost --rst_folder tmp_wsc_perf_tx8_tacos
...
python benchmark_GA_1x4.py --suite bert.wsc_config_test --num-hosts 1 --num-devices-per-host 4 --no-separate-process --only-mapping --hardware wsc --use-analytical-perf-model --rst_folder tmp_gpu_analytical_GA_bert

python benchmark_GA_1dim.py --suite bert.wsc_config_test --num-hosts 1 --num-devices-per-host 25 --no-separate-process --only-mapping --hardware wsc --use-analytical-perf-model --rst_folder tmp_gpu_analytical_GA_bert_25