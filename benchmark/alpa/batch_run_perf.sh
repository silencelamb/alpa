...
# Bellow is 5x5 DOJO
# close offload for gpt
python benchmark.py --suite gpt.wsc_perf --num-hosts 5 --num-devices-per-host 5 --hardware dojo --rst_folder tmp_dojo
# open offload for gpt
python benchmark.py --suite gpt.wsc_perf --offload --num-hosts 5 --num-devices-per-host 5 --hardware dojo --rst_folder tmp_dojo 
# close offload for bert
python benchmark.py --suite bert.wsc_perf --num-hosts 5 --num-devices-per-host 5 --hardware dojo --rst_folder tmp_dojo
# open offload for bert
python benchmark.py --suite bert.wsc_perf --offload --num-hosts 5 --num-devices-per-host 5 --hardware dojo --rst_folder tmp_dojo 
# close offload for wresnet
python benchmark.py --suite wresnet.wsc_perf --num-hosts 5 --num-devices-per-host 5 --hardware dojo --rst_folder tmp_dojo
# open offload for wresnet
python benchmark.py --suite wresnet.wsc_perf --offload --num-hosts 5 --num-devices-per-host 5 --hardware dojo --rst_folder tmp_dojo 
