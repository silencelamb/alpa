...
wresnet_num_batchs = [64]  # [64, 128, 256, 1536]


dojo_auto_layers = 10
wresnet_dojo_num_batchs = [40]  # [40, 200, 1000]
...
wsc_perf_suite = {
    ...
    25:  flatten_list([
        ...
        [
            ...
            for mod in wresnet_dojo_models.values()
            for num_batchs in wresnet_dojo_num_batchs
    ...
    24: flatten_list([
        ...
        [
            ...
            get_solution_cases(batch_size=wsgpu_global_batch,
                               ...
                               submesh_autosharding_option_dicts=[force_dp] * pp)
            for mod in wresnet_models.values()
            for num_batchs in wresnet_num_batchs
