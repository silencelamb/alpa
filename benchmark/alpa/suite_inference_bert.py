...
get_config(bert_specs["Base"], [1], [1], [1, 2, 4, 8], [1, 256], [1, 4, 16, 64])
get_config(bert_specs["Base"], [1], [1, 2, 4, 8], [1], [1, 256], [1, 4, 16, 64],
           ignore_one_device_case=True)
get_config(bert_specs["Base"], [1, 2, 4, 8], [1], [1], [1, 256], [1, 4, 16, 64],
           ignore_one_device_case=True)
