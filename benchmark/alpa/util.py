...
def compute_wresnet_tflops(batch_size, image_size, num_layers, 
    ...
    param_count = compute_wresnet_parameter_count(image_size, num_layers, num_channels, width_factor)
    total_flop = 2*param_count*batch_size*image_size*image_size*num_gpus
