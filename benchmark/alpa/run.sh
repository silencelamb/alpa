...
python benchmark.py --suite  gpt.perf_test_suite --num-hosts 8 --num-devices-per-host 8 --no-separate-process --only-mapping --use-analytical-perf-model  --rst_folder tmp_a100_gpu_analytical
