...
from mapping_simple_mask_all_ave_env import MappingSimpleMaskALLAVEEnv
import sys
sys.path.insert(0, "..")
from cnn_extractor import MeshCNN

# Vectorize the environment
vec_env = DummyVecEnv([lambda: MappingSimpleMaskALLAVEEnv(render_mode='human', use_image=True)])
