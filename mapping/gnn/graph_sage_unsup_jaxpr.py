# from https://github.com/pyg-team/pytorch_geometric/blob/master/examples/graph_sage_unsup_ppi.py
...
from JaxPRDataset import JaxPRDataset
from torch_geometric.loader import DataLoader, LinkNeighborLoader
from torch_geometric.nn import GraphSAGE

path = osp.join(osp.dirname(osp.realpath(__file__)), '..', 'data', 'JaxPR')
train_dataset = JaxPRDataset(path, split='train')
